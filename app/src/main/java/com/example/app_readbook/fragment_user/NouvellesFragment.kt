...
class NouvellesFragment : Fragment() {
    private lateinit var rootView: View
    lateinit var recyclerviewHome : RecyclerView
    lateinit var adapter: NoulsAdapter
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_nouvelles, container, false)
        ...
        adapter = NoulsAdapter(requireContext(), mutableListOf(), this)
